...
public class PayServiceImpl implements PayService {
    ...
    public ResponseResult refund(Long orderId) {
        ...
        // 退款成功，更新数据库的订单状态
        iOrderService.updateOrderDetailStatus(orderId, OrderStatus.REFUND);
        // 将库存还原
        // 拿出该订单下单的所有商品，依次还原库存
