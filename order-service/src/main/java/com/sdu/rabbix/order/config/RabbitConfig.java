package com.sdu.rabbix.order.config;

import com.sdu.rabbix.order.listener.DelayQueueListener;
import com.sdu.rabbix.order.service.impl.OrderMessageService;
